...
### Run Test 1 (overall accuracy):
```bash
python main.py --test1
```

### Run Test 2 (topic-based accuracy):
```bash
...
```bash
python main.py --check-answers-distribution
```

### Use custom questions file:
```bash
python main.py --test1 --questions-csv path/to/questions.csv
```